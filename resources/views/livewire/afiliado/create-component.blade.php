            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-pills nav-fill mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link position-relative" id="pills-step1-tab" data-bs-toggle="pill"
                            ...
                            <form wire:submit.prevent="store" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="numero_afiliado" wire:model="model.numero_afiliado"
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="cargo" wire:model="model.cargo"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-8">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="nombre_completo" wire:model="model.nombre_completo"
                                    ...
                                    <div class="col-xs-12 col-md-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="numero_matricula" wire:model="model.numero_matricula"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-3">
                                        <div class="form-floating mb-3">
                                            <input type="number" name="ci" wire:model="model.ci"
                                    ...
                                    <div class="col-xs-12 col-md-2">
                                        <div class="form-floating  mb-3">
                                            <select wire:model="model.expedido"
                                    ...
                                    <div class="col-xs-12 col-md-7">
                                        <div class="form-floating mb-3">
                                            <input type="date" name="fecha_nacimiento" wire:model="model.fecha_nacimiento"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="grupo_sanguineo" wire:model="model.grupo_sanguineo"
                                    ...
                                    <div class="col-xs-12 col-md-8">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="egreso" wire:model="model.egreso"
                                ...
                                <div class="form-floating mb-3">
                                    <textarea name="domicilio" wire:model="model.domicilio"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" name="telefono" wire:model="model.telefono"
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="file" name="foto" wire:model="file"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" name="anos_servicio" wire:model="model.anos_servicio"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-end">
                                    ...
                                    <button class="btn btn-primary" id="pills-home-tab" data-bs-toggle="pill"
