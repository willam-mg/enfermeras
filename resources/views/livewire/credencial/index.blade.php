                ...
                @if (count($data) > 0)
                    @foreach ($data as $key => $item)
                        <tr class="{{$idCredencial === $item->id?'table-success':''}}" onclick="onSelectIdCredencial({{$item->id}}, this, event)" title="Seleccionar credencial">
                            ...
                            <td>
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle" type="button" id="credencial_dropdownActions{{$item->id}}" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bi bi-three-dots-vertical"></i>
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="credencial_dropdownActions{{$item->id}}">
                                        <li>
