<div>
    <x-page.loading />
    <div wire:ignore.self class="modal bg-modal-over" id="modal-credencial-edit" tabindex="-1">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Editar credencial {{$model->id}}</h5>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-floating  mb-3">
                                    <select wire:model.defer="model.renovacion" id="renovacion" class="form-select @error('model.renovacion') is-invalid @enderror" name="renovacion" aria-label="Renovacion">
                                        <option {{$model->renovacion == \App\Models\Credencial::RENOVACION_NO?'selected':''}} value="{{\App\Models\Credencial::RENOVACION_NO}}" title="No"> No </option>
                                        <option {{$model->renovacion == \App\Models\Credencial::RENOVACION_SI?'selected':''}} value="{{\App\Models\Credencial::RENOVACION_SI}}" title="Si"> Si </option>
                                    </select>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-floating  mb-3">
                                    <select wire:model.defer="model.estado" id="estado"
                                        ...
                                        <option {{$model->estado == \App\Models\Credencial::ESTADO_PENDIENTE?'selected':''}} value="{{\App\Models\Credencial::ESTADO_PENDIENTE}}" title="Pendiente"> Pendiente </option>
                                        <option {{$model->estado == \App\Models\Credencial::ESTADO_ENTREGADO?'selected':''}} value="{{\App\Models\Credencial::ESTADO_ENTREGADO}}" title="Entregado"> Entregado </option>
                                    </select>
